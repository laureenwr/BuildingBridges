    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <Card className="mb-8 border-[rgba(145,82,255,0.15)] shadow-[0_8px_32px_rgba(145,82,255,0.13)]">
        <CardContent className="prose max-w-none p-6 prose-headings:font-lora prose-headings:text-[#1A1033] prose-p:text-[#6B5F8A] prose-li:text-[#6B5F8A]">
          ...
          <p>
            {isDe
              ? 'Building Bridges ist eine Austausch- und Vernetzungsplattform, die das Teilen von Erfahrungsberichten, Perspektiven und Lösungsansätzen ermöglicht. Die Plattform wird von der Freien Universität Berlin in Zusammenarbeit mit der Stiftung SPI und der Universität Duisburg-Essen betrieben.'
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>{isDe ? 'Nutzer*innen entscheiden eigenverantwortlich über die geteilten Inhalte' : 'Users are responsible for what they choose to share'}</li>
            <li>{isDe ? 'Die Plattform richtet sich an Mädchen und FLINTA of Color im Alter von 16-18 Jahren' : 'The platform is intended for girls and FLINTA of Color aged 16-18'}</li>
          </ul>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>{isDe ? 'Detailangaben können dennoch Rueckschluesse auf Identitaeten ermoeglichen' : 'Details may still allow inferences about identities'}</li>
            <li>{isDe ? 'Nutzer*innen sind für ihre eingestellten Inhalte selbst verantwortlich' : 'Users are responsible for the content they submit'}</li>
          ...
          <p>
            {isDe
              ? 'Mit dem Einstellen von Beitraegen erteilen Nutzer*innen der Plattform ein nicht-exklusives, weltweites und unbefristetes Nutzungsrecht zur Verwendung, Speicherung und Verarbeitung, vorrangig für wissenschaftliche Zwecke und zur Optimierung der Plattform.'
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">{isDe ? '5. Moderation & Unterstützung' : '5. Moderation & support'}</h3>
          <p>
            {isDe
              ? 'Ein geschultes Moderationsteam überwacht die Inhalte und bietet bei emotional belastenden Situationen Unterstützung an.'
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>{isDe ? 'Die Betreiber haften nicht für Fehler, Vollständigkeit oder Aktualität der Inhalte' : 'Operators are not liable for errors, completeness, or timeliness of content'}</li>
          ...
          <p>{isDe ? 'Bei Fragen oder Anliegen können Sie sich an uns wenden:' : 'For questions or concerns, please contact us:'}</p>
