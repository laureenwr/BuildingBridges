...
export default function AdminStoriesPublishedPage() {
  return (
    <div className="rounded-2xl border border-[rgba(145,82,255,0.12)] bg-white p-8 shadow-[0_10px_36px_rgba(145,82,255,0.09)]">
      ...
      <p className="mt-3 max-w-prose leading-relaxed text-[#5C5275]">
        Celebrate community voices safely — map this view to{' '}
        <code className="rounded-md bg-[#FAF8FF] px-1 py-0.5 text-[0.8rem] text-[#7339E0]">published</code> records once wired.
      </p>
      <Link
        href="/portal/admin"
