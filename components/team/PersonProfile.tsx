...
const bioOverrides: Record<string, { de: string; en: string }> = {
  ...
  'sumera-sajid': {
    de: 'Masterstudentin in Web & Data Science an der Universität Koblenz. Sie wirkt an der Building Bridges Plattform mit und legt den Fokus auf User Experience, Storytelling und inklusives digitales Design. Ihre Arbeit verbindet datengetriebenes Denken mit nutzerzentrierter Gestaltung, um zugängliche und sinnvolle digitale Erfahrungen zu schaffen. Besonders interessiert sie sich dafür, wie Technologie Communities stärken, vielfältige Stimmen sichtbar machen und inklusive Räume für Lernen und Austausch schaffen kann.',
  ...
  'hannes-rothe': {
    de: 'Professor und Inhaber des Lehrstuhls für Sustainability and Innovation in Digital Ecosystems an der Universität Duisburg-Essen sowie Leiter von Place Beyond Bytes. Seine Arbeitsschwerpunkte in der Lehre sind digitale Innovation, Entrepreneurship und maschinelles Lernen. Seine Forschung bewegt sich an der Schnittstelle von digitaler Innovation und Entrepreneurship, Management digitaler Ökosysteme sowie der Organisation von Daten und Wissen.',
  ...
  'daniel-courtney': {
    de: 'Wissenschaftlicher Mitarbeiter an der Universität Duisburg-Essen am Lehrstuhl für Sustainability and Innovation in Digital Ecosystems. Er arbeitet in Projekten wie Building Bridges und "EHDS for All" mit. Mit einem Hintergrund in Human-Computer Interaction und Psychologie konzentriert sich seine Arbeit auf User Experience, Human-Centered Design sowie die Interaktion zwischen Menschen und digitalen Technologien. Seine Forschungsinteressen umfassen UX-Design und -Forschung, Human Factors sowie Verhaltenswissenschaften.',
  ...
  'laureen-warikoru': {
    de: 'Wissenschaftliche Mitarbeiterin an der Universität Duisburg-Essen am Lehrstuhl für Sustainability and Innovation in Digital Ecosystems. Ihre Arbeitsschwerpunkte liegen in Human-Computer Interaction, kognitiver Psychologie und Verhaltenswissenschaften. Sie interessiert sich besonders dafür zu verstehen, wie Menschen mit digitalen Systemen interagieren und wie diese Erfahrungen intuitiver und nutzerzentrierter gestaltet werden können.',
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <Card className="p-6">
              ...
              <ul className="text-gray-700 space-y-1">
                ...
                {m.links?.length ? (
                  <li className="pt-2">
                    {isDe ? 'Weiterführende Links' : 'Related links'}:
